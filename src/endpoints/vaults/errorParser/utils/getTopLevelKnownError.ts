...
export function getTopLevelKnownError(ethersError: EthersError): ReturnValue | undefined {
  if (
  ...
  if (ethersError.code === ETHERS_ERROR_CODES.CALL_EXCEPTION && ethersError.reason !== undefined) {
    return {
